...
export declare function withDefaultGetters<ITEM, GROUP>(props: ContextMenuLevelsProps<ITEM, GROUP>): ({
    items: ITEM[];
    size?: import("./types").ContextMenuPropSize;
    direction?: import("../Popover").Direction;
    offset?: import("../Popover").PopoverPropOffset;
    ...
    onClickOutside?: import("../../hooks/useClickOutside").ClickOutsideHandler;
    isOpen?: boolean;
    ...
    setComponentSize: React.Dispatch<React.SetStateAction<import("../../hooks/useComponentSize").ComponentSize>>;
