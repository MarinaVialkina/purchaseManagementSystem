...
export type UserSelectPropGetItemSubLabel<ITEM> = (item: ITEM) => string | undefined;
export type UserSelectPropGetItemAvatarUrl<ITEM> = (item: ITEM) => string | undefined;
export type UserSelectPropGetItemKey<ITEM> = (item: ITEM) => string | number;
export type UserSelectPropGetItemGroupKey<ITEM> = (item: ITEM) => string | number | undefined;
export type UserSelectPropGetItemDisabled<ITEM> = (item: ITEM) => boolean | undefined;
export type UserSelectPropGetGroupKey<GROUP> = (group: GROUP) => string | number;
export type UserSelectPropGetGroupLabel<GROUP> = (group: GROUP) => string;
export type UserSelectPropSearchFunction<ITEM> = (item: ITEM, searchValue: string) => boolean;
type UserSelectPropOnChange<ITEM, MULTIPLE extends boolean> = (value: (MULTIPLE extends true ? ITEM[] : ITEM) | null, props: {
...
export type UserSelectComponent = <ITEM = UserSelectItemDefault, GROUP = UserSelectGroupDefault, MULTIPLE extends boolean = false>(props: UserSelectProps<ITEM, GROUP, MULTIPLE>) => React.ReactNode | null;
