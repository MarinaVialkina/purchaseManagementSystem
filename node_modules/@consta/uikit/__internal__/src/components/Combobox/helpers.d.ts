...
export type ComboboxPropGetItemGroupKey<ITEM> = (item: ITEM) => string | number | undefined;
export type ComboboxPropGetItemDisabled<ITEM> = (item: ITEM) => boolean | undefined;
...
type ComboboxPropSearchFunction<ITEM> = (item: ITEM, searchValue: string) => boolean;
type ComboboxPropOnChange<ITEM, MULTIPLE extends boolean> = (value: (MULTIPLE extends true ? ITEM[] : ITEM) | null, props: {
    e: React.SyntheticEvent;
}) => void;
type ComboboxPropValue<ITEM, MULTIPLE extends boolean> = (MULTIPLE extends true ? ITEM[] : ITEM) | null | undefined;
export type ComboboxPropRenderItem<ITEM> = (props: RenderItemProps<ITEM>) => React.ReactNode | null;
export type ComboboxPropRenderValue<ITEM> = (props: RenderValueProps<ITEM>) => React.ReactNode | null;
type ComboboxPropOnCreate = (label: string, props: {
    e: React.SyntheticEvent;
}) => void;
export type ComboboxProps<ITEM = ComboboxItemDefault, GROUP = ComboboxGroupDefault, MULTIPLE extends boolean = false> = PropsWithHTMLAttributesAndRef<{
    items: ITEM[];
...
export type ComboboxComponent = <ITEM = ComboboxItemDefault, GROUP = ComboboxGroupDefault, MULTIPLE extends boolean = false>(props: ComboboxProps<ITEM, GROUP, MULTIPLE>) => React.ReactNode | null;
