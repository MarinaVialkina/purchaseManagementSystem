...
export type ProgressStepBarPropGetItemTooltipContent<ITEM> = (item: ITEM) => string | undefined;
export type ProgressStepBarPropGetItemLineStatus<ITEM> = (item: ITEM) => ProgressStepBarPropStatus | undefined;
export type ProgressStepBarPropGetItemPoint<ITEM> = (item: ITEM) => ProgressStepBarPointNumbersMap | IconComponent | undefined;
export type ProgressStepBarPropGetItemProgress<ITEM> = (item: ITEM) => boolean | undefined;
export type ProgressStepBarPropGetItemContent<ITEM> = (item: ITEM) => React.ReactNode | undefined;
export type ProgressStepBarPropGetItemStatus<ITEM> = (item: ITEM) => ProgressStepBarPropStatus | undefined;
export type ProgressStepBarPropGetItemOnClick<ITEM> = (item: ITEM) => React.EventHandler<React.MouseEvent> | undefined;
...
export type ProgressStepBarPropOnItemClick<ITEM> = (item: ITEM, props: {
    e: React.MouseEvent;
    index: number;
}) => void;
export type ProgressStepBarProps<ITEM = ProgressStepBarItemDefault> = PropsWithHTMLAttributesAndRef<{
    steps: ITEM[];
...
} & Omit<React.HTMLAttributes<HTMLDivElement>, "css" | "size" | "getItemLabel" | "getItemStatus" | "getItemProgress" | "direction" | "onItemClick" | "getItemOnClick" | "getItemContent" | "steps" | "activeStepIndex" | "getItemLineStatus" | "getItemTooltipContent" | "getItemPoint"> & React.RefAttributes<HTMLDivElement> & (ITEM extends {
    label: ProgressStepBarItemDefault["label"];
} ? {} : {
    getItemLabel: ProgressStepBarPropGetItemLabel<ITEM>;
}) & {
